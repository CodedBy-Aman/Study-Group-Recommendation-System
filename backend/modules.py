...
from database import Base #imort batabase from databae.py ...as we are using Base to create Table

class Student(Base):    # creates a class named student this represents a table called  student in database
    __tablename__ = "students"
                                ## Table student has attribut id ,nam ,subject,skill level in form of column
